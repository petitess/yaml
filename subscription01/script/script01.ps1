...
$billingAccounts = '147db654-8228-43a1-acf8-32cb5b4c5d92:b5b6fef4-e666-4fd2-b303-98219d087695_2019-05-31'
$billingProfile = 'ISVR-U5HS-BG7-PGB'
$invoiceSections = 'TUJ4-QLVW-PJA-PGB'
...
$rbac = "Owner"
$devopsOrg = "https://dev.azure.com/ssgse"
